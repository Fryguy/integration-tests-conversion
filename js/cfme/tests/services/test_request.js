...
function test_copy_request_bz1194479(appliance, provider, catalog_item, request) {
  // Automate BZ 1194479
  // 
  //   Polarion:
  //       assignee: nansari
  ...
  if (!navigate_to(service_request, "Details")) throw new ()
};
...
//   
// pass
function test_services_requester_dropdown_sorting() {}
