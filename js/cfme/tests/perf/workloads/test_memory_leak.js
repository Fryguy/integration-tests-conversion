...
function prepare_workers(appliance) {
...
function test_workload_memory_leak(request, scenario, appliance, provider) {
  ...
  let scenario_data = {
    ...
    appliance_roles: roles_memory_leak.join(","),
    scenario: scenario
  };
