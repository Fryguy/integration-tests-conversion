...
function rails_delete_filter(request) {
  // Introspect a function bound filter_name and use ssh_client and rails to delete it
  yield;
  let filter_name = request.function.getattr("filter_name", null);
...
function test_can_open_provider_advanced_search(advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_provider_filter_without_user_input(advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_provider_filter_with_user_input(advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_provider_filter_with_user_input_and_cancellation(advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_provider_filter_save_cancel(rails_delete_filter, advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
  ...
  if (!advanced_search_view.entities.search.save_filter(
    "fill_count(Infrastructure Provider.VMs, >)",
    test_provider_filter_save_cancel.filter_name,
    {cancel: true}
  )) throw new ();

  advanced_search_view.flash.assert_no_error();
  if (!advanced_search_view.entities.search.reset_filter()) throw new ();
...
function test_provider_filter_save_and_load(rails_delete_filter, advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
  ...
  if (!advanced_search_view.entities.search.load_filter(test_provider_filter_save_and_load.filter_name)) {
    throw new ()
  };
...
function test_provider_filter_save_and_cancel_load(rails_delete_filter, advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
  ...
  if (!advanced_search_view.entities.search.load_filter(
    test_provider_filter_save_and_cancel_load.filter_name,
    {cancel: true}
  )) throw new ();
...
function test_provider_filter_save_and_cancel_load_with_user_input(rails_delete_filter, advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_quick_search_without_provider_filter(request) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_quick_search_with_provider_filter(request) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_can_delete_provider_filter(advanced_search_view) {
  // 
  //   Polarion:
  //       assignee: gtalreja
  //       casecomponent: WebUI
...
function test_delete_button_should_appear_after_save_provider(rails_delete_filter, advanced_search_view) {
...
function test_cannot_delete_provider_filter_more_than_once(advanced_search_view) {
  ...
  if (!advanced_search_view.entities.search.load_filter(filter_name)) {
    throw new ()
  };
  ...
  if (!!advanced_search_view.entities.search.delete_filter()) {
