...
pytestmark = [pytest.mark.tier(2), pytest.mark.provider(classes: [InfraProvider], selector: ONE_PER_TYPE), pytest.mark.usefixtures("setup_provider"), test_requirements.rhev, test_requirements.general_ui]
