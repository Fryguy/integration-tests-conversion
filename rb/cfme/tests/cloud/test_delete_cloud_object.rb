...
pytestmark = [pytest.mark.tier(2), test_requirements.cloud, pytest.mark.usefixtures("setup_provider_modscope"), pytest.mark.provider([CloudProvider], required_fields: ["remove_test"], scope: "module")]
...
def test_delete_stack_appear_after_refresh(appliance, provider, provisioning, request)
  #  Tests delete stack
  # 
  #   Metadata:
  #       test_flag: delete_object
  ...
  #       initialEstimate: 1/4h
  #   
  stack = appliance.collections.cloud_stacks.instantiate(name: provisioning["stacks"][0], provider: provider)
  stack.delete()
  begin
