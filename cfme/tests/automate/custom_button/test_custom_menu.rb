...
ADVANCE_SETTING_CUSTOM_MENU = {"ui" => {"custom_menu" => [{"type" => "item", "icon" => "fa fa-cubes", "id" => "redhat", "name" => "RedHat", "href" => "https://www.redhat.com", "rbac" => "vm_explorer"}, {"type" => "item", "icon" => "pficon pficon-project", "id" => "manageiq", "name" => "ManageIQ", "href" => "https://manageiq.org", "rbac" => "vm_explorer"}]}}
