...
custom_attributes_to_add = [{"name" => "custom1", "value" => "first value"}, {"name" => "custom2", "value" => "second value"}]
custom_attributes_to_edit = [{"name" => "custom1", "value" => "third value"}, {"name" => "custom2", "value" => "fourth value"}]
...
def verify_custom_attributes(appliance, provider, custom_attributes_to_verify)
  ...
  for custom_attribute in custom_attributes_to_verify
    raise unless view.entities.summary("Custom Attributes").get_text_of(custom_attribute["name"]) == custom_attribute["value"].to_s.to_s
  end
end
def test_manageiq_ansible_add_custom_attributes(appliance, ansible_custom_attributes, provider)
  ...
  #   
  setup_ansible_script(provider, script: "add_custom_attributes", values_to_update: custom_attributes_to_add, script_type: "custom_attributes")
  run_ansible("add_custom_attributes")
  verify_custom_attributes(appliance: appliance, provider: provider, custom_attributes_to_verify: custom_attributes_to_add)
  setup_ansible_script(provider, script: "remove_custom_attributes", values_to_update: custom_attributes_to_add, script_type: "custom_attributes")
...
def test_manageiq_ansible_edit_custom_attributes(appliance, ansible_custom_attributes, provider)
  ...
  #       initialEstimate: 1/6h
  #   
  setup_ansible_script(provider, script: "add_custom_attributes", values_to_update: custom_attributes_to_edit, script_type: "custom_attributes")
  run_ansible("add_custom_attributes")
  verify_custom_attributes(appliance: appliance, provider: provider, custom_attributes_to_verify: custom_attributes_to_edit)
  setup_ansible_script(provider, script: "remove_custom_attributes", values_to_update: custom_attributes_to_edit, script_type: "custom_attributes")
  run_ansible("remove_custom_attributes")
  view = navigate_to(provider, "Details", force: true)
  raise unless !view.entities.summary("Custom Attributes").is_displayed
end
def test_manageiq_ansible_add_custom_attributes_same_name(appliance, ansible_custom_attributes, provider)
...
def test_manageiq_ansible_add_custom_attributes_bad_user(appliance, ansible_custom_attributes, provider)
  ...
  #       initialEstimate: 1/6h
  #   
  setup_ansible_script(provider, script: "add_custom_attributes_bad_user", values_to_update: custom_attributes_to_edit, script_type: "custom_attributes")
  run_result = run_ansible("add_custom_attributes_bad_user")
  raise unless run_result.decode("utf-8").include?("Authentication failed")
  view = navigate_to(provider, "Details", force: true)
  raise unless !view.entities.summary("Custom Attributes").is_displayed
end
